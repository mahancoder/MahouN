...
class ValidationResult:
    ...
    def __init__(
        ...
        symbolic_facts: Optional[List[str]] = None,
...
class SymbolicFactExtractor:
        ...
        if not extracted_facts:
            ...
            logger.warning(
                ...
                extra={
                    ...
                    "fallback_fact": extracted_facts[0]
                }
            )
    ...
    def _convert_to_symbolic_fact(self, text: str) -> Optional[str]:
...
class NeuralOutputValidator:
    ...
    def _validate_via_forward_chaining(
        ...
        try:
            ...
            logger.warning(
                f"Forward chaining validation failed: {e}",
                extra={"symbolic_facts": symbolic_facts}
            )
            return ValidationResult(
                valid=False,
                confidence=0.0,
    ...
    def _validate_via_backward_chaining(
        ...
        try:
            ...
            logger.warning(
                f"Backward chaining validation failed: {e}",
                extra={"symbolic_facts": symbolic_facts}
            )
            return ValidationResult(
                valid=False,
    ...
    def _validate_evidence_grounding(
        ...
        try:
            ...
            logger.warning(
                f"Evidence grounding validation failed: {e}",
                extra={"symbolic_facts": symbolic_facts}
            )
            return ValidationResult(
                valid=False,
...
_neural_validator: Optional[NeuralOutputValidator] = None
