...
class ReasoningDependencyContainer:
    ...
    def __init__(self):
        ...
        self._query_router: Optional[QueryRouterProtocol] = None
        self._rag_service: Optional[RAGServiceProtocol] = None
        self._model_orchestrator: Optional[ModelOrchestratorProtocol] = None
        self._reasoning_engine: Optional[ReasoningEngineProtocol] = None
        self._contradiction_detector: Optional['ContradictionDetectorProtocol'] = None
        ...
        if self._query_router is None:
            with self._router_lock:
                ...
                if self._query_router is None:
                    ...
                    validate_protocol_implementation(
                        self._query_router, QueryRouterProtocol
                    )
        ...
        if self._rag_service is None:
            with self._rag_lock:
                if self._rag_service is None:
                    ...
                    validate_protocol_implementation(
                        self._rag_service, RAGServiceProtocol
                    )
        ...
        if self._model_orchestrator is None:
            with self._orchestrator_lock:
                if self._model_orchestrator is None:
                    ...
                    validate_protocol_implementation(
                        self._model_orchestrator, ModelOrchestratorProtocol
                    )
        ...
        if self._reasoning_engine is None:
            with self._engine_lock:
                if self._reasoning_engine is None:
                    ...
                    validate_protocol_implementation(
                        self._reasoning_engine, ReasoningEngineProtocol
                    )
    ...
    def _create_query_router(self) -> QueryRouterProtocol:
        ...
        if router is None:
            raise RuntimeError(
                "QueryRouter not available. "
                "Ensure mahoun.rag module is installed and configured."
            )
        return router
    ...
    def _create_rag_service(self) -> RAGServiceProtocol:
        ...
        if service is None:
            raise RuntimeError(
                "HybridRAGService not available. "
                "Ensure mahoun.rag.hybrid_rag_service is installed."
            )
        return service
    ...
    def _create_reasoning_engine(self) -> ReasoningEngineProtocol:
        ...
        if engine is None:
            raise RuntimeError(
                "UnifiedReasoningEngine not available. "
                "Ensure mahoun.reasoning.unified_engine is installed."
            )
        return engine
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"ReasoningDependencyContainer("
            f"initialized={initialized_count}/{total_count}, "
            f"status={status})"
        )
...
_global_container: Optional[ReasoningDependencyContainer] = None
...
class MockDependencyContainer(ReasoningDependencyContainer):
    ...
    def __init__(
        self,
        query_router: Optional[QueryRouterProtocol] = None,
        rag_service: Optional[RAGServiceProtocol] = None,
        model_orchestrator: Optional[ModelOrchestratorProtocol] = None,
