...
Usage:
    from mahoun.pipelines.graph.entity_linker import EntityLinker, link_entities_to_graph
...
def link_entities_to_graph(
    ...
    Example:
        ...
        >>> from mahoun.pipelines.graph.entity_linker import link_entities_to_graph
        >>> 
