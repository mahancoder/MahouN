...
from mahoun.finetuning.data_augmentation import PersianLegalSynonymDict
...
class SemanticMatcher:
    ...
    def _build_negation_list(self) -> List[str]:
        ...
        return [
            ...
            # Verb negations
            "ندارد", "ندارند", "نداشت", "نداشتند",
            "نباید", "نبایست", "نباشد", "نباشند",
            "نمی‌شود", "نمی‌توان", "نمی‌تواند",
            "نکرد", "نکرده", "نکند", "نکنند",
    ...
    def are_contradictory(self, text1: str, text2: str) -> bool:
        ...
        if has_negation1 != has_negation2:
            ...
            if len(common_words) > 0:
                log.debug(
                    f"Contradiction detected: negation mismatch on common concepts {common_words}"
                )
                return True
